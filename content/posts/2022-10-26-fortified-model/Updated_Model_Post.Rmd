...
```{r create incumbency variable and attach existing data}
...
```{r make national incumbency variable and add into natl dataset}
# add GDP into poll: ???
...
```{r make glm model and predictions}
...
```{r district by district data, and attach existing generic ballot and rdi data}
...
```{r make 2022 prediction datasets}
